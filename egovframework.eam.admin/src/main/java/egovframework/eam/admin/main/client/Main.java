...
public class Main implements EntryPoint, ValueChangeHandler<String> {
	...
	public void onModuleLoad() {
		...
		*/
		...
		if (SC.hasFirebug()) {
			...
			label.setContents("Firebug can make the eGov Access Management run slow. For the best performance, we suggest disabling Firebug for this site.");
	...
	protected void showMenu(TreeNode node) {
...
class GuidePane extends HTMLPane {
	public GuidePane() {
		setContentsURL("guide/index.html");
